...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_11__dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__services_auth_guard_service__["a" /* AuthGuard */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_8__profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__services_auth_guard_service__["a" /* AuthGuard */]] }
];
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_13__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_14__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__services_auth_guard_service__["a" /* AuthGuard */]],
...
var RegisterComponent = (function () {
    function RegisterComponent(validateService, _flashMessagesService, _AuthService, router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this._AuthService.registerUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                _this._flashMessagesService.show('you are registerd and can login now!', { cssClass: 'alert-danger', timeout: 2000 });
                _this.router.navigate(['/login']);
            }
            else {
